...
WITH
  projection_1 AS (
    ...
    WHERE (("/BIC/EYRULCD" = 'G02' or "/BIC/EYRULCD" = 'G07' ) AND "CALDAY">= SUBSTRING(TO_VARCHAR(ADD_DAYS(CURRENT_DATE, -365)), 1, 4) + '0101')
  ),
  pthlgy AS (
    SELECT
    ...
    WHERE ("/BIC/EYPATREV" = '00' AND "/BIC/EYSAMDT" > SUBSTRING(TO_VARCHAR(ADD_DAYS(CURRENT_DATE, -365)), 1, 4) + '0101')
  ),
  pthlgy_rev_zero AS (
    SELECT
        SAPABAP1."/BIC/AEYO_RW0800"."/BIC/EYILABNO" AS "_BIC_EYILABNO",
        ...
        SAPABAP1."/BIC/AEYO_RW0800"."/BIC/EYPATIENT" AS "_BIC_EYPATIENT"
    FROM SAPABAP1."/BIC/AEYO_RW0800"
    WHERE ("/BIC/EYPATREV" = '00' AND "/BIC/EYSAMDT" > SUBSTRING(TO_VARCHAR(ADD_DAYS(CURRENT_DATE, -365)), 1, 4) + '0101' AND (not (("/BIC/EYEVNTID") IS NULL) or "/BIC/EYEVNTID" != ''))
  ),
  pthlgy_rev_1_n AS (
    SELECT
        SAPABAP1."/BIC/AEYO_RW0800"."/BIC/EYILABNO" AS "_BIC_EYILABNO",
        ...
        SAPABAP1."/BIC/AEYO_RW0800"."/BIC/EYPATIENT" AS "_BIC_EYPATIENT"
    FROM SAPABAP1."/BIC/AEYO_RW0800"
    WHERE ("/BIC/EYPATREV" != '00' AND "/BIC/EYSAMDT" > SUBSTRING(TO_VARCHAR(ADD_DAYS(CURRENT_DATE, -365)), 1, 4) + '0101' AND ((("/BIC/EYEVNTID") IS NULL) or "/BIC/EYEVNTID" = ''))
  ),
  projection_4 AS (
    SELECT
    ...
    WHERE ("CALDAY" > SUBSTRING(TO_VARCHAR(ADD_DAYS(CURRENT_DATE, -365)), 1, 4) + '0101')
  ),
  aggregation_1 AS (
    SELECT
        agg_inner.*,

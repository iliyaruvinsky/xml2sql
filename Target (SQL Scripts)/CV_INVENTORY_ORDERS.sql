  ...
  aggregation AS (
    SELECT * FROM (
      SELECT
          ...
          join_4.WKURS_EKKO AS WKURS_EKKO,
          join_4.KTMNG_EKPO AS KTMNG_EKPO,
          join_4.MENGE_EKPO AS MENGE_EKPO,
          join_4.NETPR_EKPO AS NETPR_EKPO,
          join_4.PEINH_EKPO AS PEINH_EKPO,
          join_4.BRTWR_EKPO AS BRTWR_EKPO,
          join_4.EFFWR_EKPO AS EFFWR_EKPO,
          join_4.WEMNG AS WEMNG_EKET,
          join_4.MENGE AS MENGE_EKET,
          join_4.NETWR_EKPO AS NETWR_EKPO,
          join_4.ZWERT_EKPO AS ZWERT_EKPO,
          join_4.NAVNW_EKPO AS NAVNW_EKPO,
          join_4.ABMNG_EKPO AS ABMNG_EKPO,
          join_4.NTGEW_EKPO AS NTGEW_EKPO,
          join_4.BRGEW_EKPO AS BRGEW_EKPO,
          join_4.VOLUM_EKPO AS VOLUM_EKPO,
          join_4.CQU_SAR_EKPO AS CQU_SAR_EKPO,
          ...
          SUBSTRING("AEDAT_EKKO", 1, 4) AS YEAR
      FROM join_4
    ) AS calc
    GROUP BY MONTH, YEAR, BSART_EKKO, BSTYP_EKKO, AEDAT_EKKO, LIFNR_EKKO, ERNAM_EKKO, EKORG_EKKO, EKGRP_EKKO, BEDAT_EKKO, ZTERM_EKKO, WAERS_EKKO, ZZNAMECO_EKKO, AEDAT_EKPO, TXZ01_EKPO, EBELN_EKPO, EBELP_EKPO, MATNR_EKPO, EMATN_EKPO, WERKS_EKPO, LGORT_EKPO, BEDNR_EKPO, MATKL_EKPO, MEINS_EKPO, KONNR_EKPO, KTPNR_EKPO, BANFN_EKPO, BNFPO_EKPO, PACKNO_EKPO, EINDT_EKET, WAERS_EKPO, GEWEI_EKPO
  )

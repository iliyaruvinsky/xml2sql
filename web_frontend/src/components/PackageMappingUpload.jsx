  ...
  return (
    <div className="package-mapping-upload">
      <div className="upload-section card">
        <h2>📦 Package Mappings Management</h2>
        ...
        <div className="upload-form">
          ...
          >
            ...
            {isDragActive ? (
              ...
              <div>
                <p>📤 Drag & drop HANA package mapping Excel file here, or click to select</p>
                <p className="hint">
            ...
            <div className="file-selected">
              ...
              {autoDetectName && (
                <div className="auto-detect-info">
                  ✅ Auto-detected instance: <strong>{autoDetectName}</strong>
                </div>
              )}
            </div>
          )}
          ...
          {uploadResult && (
            <div className={`upload-result ${uploadResult.success ? 'success' : 'error'}`}>
              <div className="result-icon">{uploadResult.success ? '✅' : '❌'}</div>
